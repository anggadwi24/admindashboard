...
const Navbar = ()=>{
    ...
    const handleToggle = (myDropMenu:any) =>{
    ...
    const handleFilter = (myDropMenu:any,myDropMenuSearch:any) =>{
        let input:any, filter, ul, li, a, i,div;
                ...
                <ul className="list-reset flex justify-between flex-1 md:flex-none items-center">
                    ...
                    <li className="flex-1 md:flex-none md:mr-3">
                        <div className="relative inline-block">
                            <button   onClick={() => handleToggle('myDropdown')} className="drop-button text-white py-2 px-2"> <span className="pr-2"><i className="em em-robot_face"></i></span> Hi, User <svg className="h-3 fill-current inline" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
